A Next.js Blog Template modified to match my interests which include things like gaming and anime. Plans are to turn this application into a blog that contains my opinions on these topic, guides, information hubs, and potentially more.
